...
| `create.body.temperature` | `{"$omitEmpty":{"$ref":"request.providerOptions.jiasu-chat.temperature"}}` |
| `create.body.top_p` | `{"$omitEmpty":{"$ref":"request.providerOptions.jiasu-chat.top_p"}}` |
| `create.body.max_tokens` | `{"$omitEmpty":{"$coalesce":[{"$ref":"request.extra.max_tokens"},{"$ref":"request.providerOptions.jiasu-chat.max_tokens"}]}}` |
| `create.body.tools` | `{"$omitEmpty":{"$ref":"request.providerOptions.jiasu-chat.tools"}}` |
| `create.body.tool_choice` | `{"$omitEmpty":{"$ref":"request.providerOptions.jiasu-chat.tool_choice"}}` |
| `create.body.response_format` | `{"$omitEmpty":{"$ref":"request.providerOptions.jiasu-chat.response_format"}}` |
| `create.body.stream` | `{"$omitEmpty":{"$ref":"request.providerOptions.jiasu-chat.stream"}}` |
| `create.body.extra_body` | `{"$omitEmpty":{"$ref":"request.providerOptions.jiasu-chat.extra_body"}}` |
| `agent.method` | `"POST"` |
...
- `providerOptions.jiasu-chat.extra_body`
- `providerOptions.jiasu-chat.max_tokens`
- `providerOptions.jiasu-chat.response_format`
- `providerOptions.jiasu-chat.stream`
- `providerOptions.jiasu-chat.temperature`
- `providerOptions.jiasu-chat.tool_choice`
- `providerOptions.jiasu-chat.tools`
- `providerOptions.jiasu-chat.top_p`
...
佳速公开文本入口兼容 OpenAI Chat Completions：POST /v1/chat/completions，Bearer sk-。不要用厂商原生协议直连上游。
    ...
    "providers": [
      {
        ...
        "create": {
          ...
          "body": {
            ...
            "temperature": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.jiasu-chat.temperature"
              }
            },
            "top_p": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.jiasu-chat.top_p"
              }
            },
            "max_tokens": {
              "$omitEmpty": {
                "$coalesce": [
                  ...
                  {
                    "$ref": "request.providerOptions.jiasu-chat.max_tokens"
                  }
                ]
              }
            },
            "tools": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.jiasu-chat.tools"
              }
            },
            "tool_choice": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.jiasu-chat.tool_choice"
              }
            },
            "response_format": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.jiasu-chat.response_format"
              }
            },
            "stream": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.jiasu-chat.stream"
              }
            },
            "extra_body": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.jiasu-chat.extra_body"
              }
            }
          }
        },
